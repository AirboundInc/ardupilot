...
const AP_Param::GroupInfo QuadPlane::var_info2[] = {
    ...
    // @User: Advanced
    AP_GROUPINFO("FTRANS_MODE", 45, QuadPlane, fwd_trans_method, uint8_t(FwdTransCompletion::AIRSPEED)),
    ...
    // @Increment: 0.5
    // @User: Advanced
    AP_GROUPINFO("FTRANS_TIME", 46, QuadPlane, fwd_trans_time, 5.0),
    ...
    // @Increment: 1
    // @User: Advanced
    AP_GROUPINFO("FTRANS_ANG", 47, QuadPlane, fwd_trans_angle_deg, 45.0),
