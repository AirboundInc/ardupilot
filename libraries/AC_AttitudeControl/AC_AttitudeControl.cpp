...
const AP_Param::GroupInfo AC_AttitudeControl::var_info[] = {
    ...
    // @Description: Time constant for relaxing the attitude setpoint
    // @Units: s
    // @Range: 0.01 10
    // @Increment: 0.01
    // @User: Standard
    AP_GROUPINFO("RELX_TC", 24, AC_AttitudeControl, _relax_time_constant, 0.4f),
    // @Param: RELX_LO
    ...
    // @Increment: 0.1
    // @User: Standard
    AP_GROUPINFO("RELX_LO", 25, AC_AttitudeControl, _low_tilt_relax, 30.0f),
    ...
    // @Increment: 0.01
    // @User: Standard
    AP_GROUPINFO("RELX_HI", 26, AC_AttitudeControl, _high_tilt_relax, 45.0f),
    ...
    // @Values: 0:Disabled, 1:Enabled
    // @User: Advanced
    AP_GROUPINFO("RELX_EN", 27, AC_AttitudeControl, _att_relax_enabled, 0),
